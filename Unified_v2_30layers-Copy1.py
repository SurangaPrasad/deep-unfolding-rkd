...
def build_agt_init(teacher_model, n_outer_S=60, inner_strategy='avg_pairs'):
    ...
    with torch.no_grad():
        ...
        # Stage 2: collapse outer -> fingerprint [J_S, 1, K+1]
        fingerprint = ss_compressed.mean(dim=1, keepdim=True)
        # Stage 3: broadcast to [J_S, I_S, K+1]
...
if run_RKD_Distillation == 1:
    ...
    lambda_log    = 0.01    # log-weighted deep supervision weight
    ...
    model_teacher.load_state_dict(
        torch.load('UPGA_J20_I120_w_0_45.pth', map_location=device))
    model_teacher.eval()
    for p in model_teacher.parameters():
        p.requires_grad_(False)
    print(f'Teacher loaded: {'UPGA_J20_I120_w_0_45.pth'}\n')
    ...
    save_path = (model_file_name_UPGA_J10 +
                 ...
                 f'_Kl{K_layers}_win{t_start_early}_045.pth')
