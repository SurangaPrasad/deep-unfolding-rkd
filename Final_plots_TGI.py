...
_ckpt_J1_AGT     = torch.load('./model/UPGA_J1.pth_I120_cell_4_AGT_mean_inner_RKDlog_30layers_Kl15_win20_TGI.pth',map_location='cpu') 
...
model_v2_c3.load_state_dict(torch.load(
    './model/UPGA_J10_320.pth_I60_cell_3_AGT_avg_pairs_noRKD_Kl15_win20_TGI.pth',map_location='cpu'))
model_v2_c3.eval()
with torch.no_grad():
