...
if run_program == 1:
    ...
    if run_RKD_Distillation2 == 1:
        ...
        model_RKD2.load_state_dict(torch.load(directory_model  + 'UPGA_J10.pth_I60_basic_sym_inner_avg_pairs_Kl15_win20.pth',map_location=device))
    ...
    if run_RKD_Distillation3 == 1:
        ...
        model_RKD3.load_state_dict(torch.load(directory_model  + 'UPGA_J10_all.pth_I60_noinit_CI_RKD_dist25.0_angle50.0_Kl15_win20.pth',map_location=device))
    ...
    if run_UPGA_J10 == 1:
        ...
        model_UPGA_J10.load_state_dict(torch.load(directory_model  + 'UPGA_J10_320.pth',map_location=device))
...
if plot_figure == 1:
    ...
    if run_RKD_Distillation == 1:
        ...
        plt.plot(
            ...
            linewidth=2,
            markersize=3,
            label='Rkd +init pth_I60_CI_RKD_sym_inner_avg_pairs_Kl15_win20'
        )
    if run_RKD_Distillation1 == 1:
    ...
    if run_RKD_Distillation3 == 1:
        ...
        plt.plot(
            ...
            linewidth=2,
            markersize=3,
            label='rkd only UPGA_J10.pth_I60_CI_RKD_sym_inner_avg_pairs_Kl15_win20'
        )    
