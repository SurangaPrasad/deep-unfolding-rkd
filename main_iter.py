...
R = R.to(device)
at = at.to(device)
# theta and ideal_beam are numpy arrays used for plotting; keep them on CPU
theta = np.asarray(theta)
ideal_beam = np.asarray(ideal_beam)
...
if run_program == 1:
    ...
    if save_result == 1:
        ...
        if run_conv_PGA == 1:
            ...
            np.savez(result_conv_PGA_file_name, name1=rate_iter_conv.cpu().numpy(), name2=tau_iter_conv.cpu().numpy(), name3=beam_conv_PGA)
        if run_UPGA_J1 == 1:
            result_UPGA_J1_file_name = directory_result + 'result_vs_iter_UPGA_J1.npz'
            np.savez(result_UPGA_J1_file_name, name1=rate_iter_UPGA_J1.cpu().numpy(), name2=tau_iter_UPGA_J1.cpu().numpy(), name3=beam_UPGA_J1)
        if run_UPGA_J10 == 1:
            result_UPGA_J10_file_name = directory_result + 'result_vs_iter_UPGA_J10.npz'
            np.savez(result_UPGA_J10_file_name, name1=rate_iter_UPGA_J10.cpu().numpy(), name2=tau_iter_UPGA_J10.cpu().numpy(), name3=beam_UPGA_J10)
        if run_UPGA_J20 == 1:
            result_UPGA_J20_file_name = directory_result + 'result_vs_iter_UPGA_J20.npz'
            np.savez(result_UPGA_J20_file_name, name1=rate_iter_UPGA_J20.cpu().numpy(), name2=tau_iter_UPGA_J20.cpu().numpy(), name3=beam_UPGA_J20)
...
if plot_figure == 1:
    ...
    plt.figure()
    if run_UPGA_J1 == 1:
        plt.plot(iter_number_UPGA_J1, rate_iter_UPGA_J1.cpu().numpy(), '--', markevery=5, color='blue', linewidth=3, markersize=7, label=label_UPGA_J1)
    if run_UPGA_J10 == 1:
        plt.plot(iter_number_UPGA_J10, rate_iter_UPGA_J10.cpu().numpy(), ':*', markevery=5, color='red', linewidth=3, markersize=7,
                 label=label_UPGA_J10)
    if run_UPGA_J20 == 1:
        plt.plot(iter_number_UPGA_J20, rate_iter_UPGA_J20.cpu().numpy(), '-', markevery=5, color='red', linewidth=3, markersize=7, label=label_UPGA_J20)
    if run_conv_PGA == 1:
        plt.plot(iter_number_conv_PGA, rate_iter_conv.cpu().numpy(), ':', markevery=5, color='black', linewidth=3, markersize=7, label=label_conv)
    if benchmark == 1:
    ...
    plt.figure()
    if run_UPGA_J20 == 1:
        objective_value = [rate_iter_UPGA_J20[i].item() - OMEGA * tau_iter_UPGA_J20[i].item() for i in range(len(rate_iter_UPGA_J20))]
    ...
    plt.legend(loc='best', fontsize="14", labelspacing  = 0.15)
    # save figure and results
    plt.savefig(directory_result + 'obj_vs_iter_' + str(Nt) + '_' + str(OMEGA) + '.png')
    plt.savefig(directory_result + 'obj_vs_iter_' + str(Nt) + '_' + str(OMEGA) + '.eps')

    # plot beam errors ////////////////////////////////////////////////////////////////////
    fig_tau = plt.figure(3)
    if run_UPGA_J1 == 1:
        plt.plot(iter_number_UPGA_J1, tau_iter_UPGA_J1.cpu().numpy(), '--', markevery=5, color='blue', linewidth=3, markersize=7, label=label_UPGA_J1)
    if run_UPGA_J10 == 1:
        plt.plot(iter_number_UPGA_J10, tau_iter_UPGA_J10.cpu().numpy(), ':*', markevery=5, color='red', linewidth=3, markersize=7,
                 label=label_UPGA_J10)
    if run_UPGA_J20 == 1:
        plt.plot(iter_number_UPGA_J20, tau_iter_UPGA_J20.cpu().numpy(), '-', markevery=5, color='red', linewidth=3, markersize=7, label=label_UPGA_J20)
    if run_conv_PGA == 1:
        plt.plot(iter_number_conv_PGA, tau_iter_conv.cpu().numpy(), ':', markevery=5, color='black', linewidth=3, markersize=7, label=label_conv)
    if benchmark == 1:
    ...
    fig_tradeoff = plt.figure(4)
    if run_UPGA_J1 == 1:
        plt.plot(tau_iter_UPGA_J1.cpu().numpy(), rate_iter_UPGA_J1.cpu().numpy(), '--', markevery=5, color='blue', linewidth=3, markersize=7, label=label_UPGA_J1)
    if run_UPGA_J10 == 1:
        plt.plot(tau_iter_UPGA_J10.cpu().numpy(), rate_iter_UPGA_J10.cpu().numpy(), ':*', markevery=5, color='red', linewidth=3, markersize=7,
                 label=label_UPGA_J10)
    if run_UPGA_J20 == 1:
        plt.plot(tau_iter_UPGA_J20.cpu().numpy(), rate_iter_UPGA_J20.cpu().numpy(), '-', markevery=5, color='red', linewidth=3, markersize=7, label=label_UPGA_J20)
    if run_conv_PGA == 1:
        plt.plot(tau_iter_conv.cpu().numpy(), rate_iter_conv.cpu().numpy(), ':', markevery=5, color='black', linewidth=3, markersize=7, label=label_conv)
    if benchmark == 1:
    ...
    plt.plot(angles_theta, np.real(beam_bm_array.cpu().numpy()), '--', markevery=5, color='green', linewidth=1,
