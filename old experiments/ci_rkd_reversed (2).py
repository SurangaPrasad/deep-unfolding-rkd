...
if run_RKD_Distillation == 1:
    ...
    save_path = model_file_name_UPGA_J10 + f'_CI_RKD_reversed_Kl{K_layers}.pth'
...
if run_RKD_Distillation == 0:
    ...
    model_test.load_state_dict(
        torch.load(model_file_name_UPGA_J10 + f'_CI_RKD_reversed_Kl{K_layers}.pth',
                   map_location=device))
    model_test.eval()
