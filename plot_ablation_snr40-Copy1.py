...
model_UPGA_J20.load_state_dict(torch.load('UPGA_J20_I120_w_0_15.pth', map_location='cpu'))
model_UPGA_J20.eval()
with torch.no_grad():
...
model_v2_c2.load_state_dict(torch.load('./model/64TX_4UE_4RF/UPGA_J10_320.pth_I60_cell_2_flat0.01_RKDlog_30layers_Kl15_win20_015.pth',
    map_location='cpu'))
model_v2_c2.eval()
with torch.no_grad():
...
model_v2_c3.load_state_dict(torch.load('./model/64TX_4UE_4RF/UPGA_J10_320.pth_I60_cell_3_AGT_avg_pairs_noRKD_Kl15_win20_015.pth',
    map_location='cpu'))
model_v2_c3.eval()
with torch.no_grad():
...
model_v2_c4.load_state_dict(torch.load('./model/64TX_4UE_4RF/UPGA_J10_320.pth_I60_cell_4_AGT_avg_pairs_RKDlog_30layers_Kl15_win20_015.pth',
    map_location='cpu'))
model_v2_c4.eval()
with torch.no_grad():
